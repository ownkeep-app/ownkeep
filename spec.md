...
- **Acceptance:** editing due date/cycle reschedules; open dated rows show the correct due-status badge; a monthly total + annualized summary is shown across all subscriptions (converted to `finance.baseCurrency` if Finance is enabled, else raw).
